...
var render = function render() {
  ...
  return _c("div", {
    ...
    return _c("li", {
      ...
      staticClass: "mb-1"
    }, [_vm._v(_vm._s(task.task.title))]), _vm._v(" "), _c("p", {
      staticClass: "mb-1"
      ...
      on: {
        click: function click($event) {
          return _vm.deleteTask(task.task.id);
        }
      }
    }, [_vm._v("Delete")])])]);
  }), 0), _vm._v(" "), _c("form", {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new vuex__WEBPACK_IMPORTED_MODULE_2__["default"].Store({
  ...
  mutations: {
    ...
    UPDATE_TASK: function UPDATE_TASK(state, updatedTask) {
      ...
      var findedTask = state.tasks.find(function (t) {
  ...
  actions: {
    ...
    completeTask: function completeTask(_ref2, task) {
      var commit = _ref2.commit;
      commit('UPDATE_TASK', task);
    },
    deleteTask: function deleteTask(_ref3, taskId) {
      var commit = _ref3.commit;
      axios__WEBPACK_IMPORTED_MODULE_0___default().post("/tasks/".concat(taskId)).then(function () {
